...
function Product() {
  ...
  return (
    <div
      ...
      className="!bg-no-repeat !bg-cover h-screen   1440:w-[1216px] mx-auto  "
    >
      <div className="flex flex-col   xl:w-[1216px] mx-auto ">
        ...
        <div className="  w-fit mx-auto  flex flex-col lg:flex-row   justify-center gap-24 pt-8">
          ...
          <div className="flex  flex-col  sm:mx-auto lg:mx-0  bg-red-300 xs:w-full w-[429px] items-center justify-center  gap-2 ">
            ...
            <Button className=" text-white w-full text-xs py-3 bg-primaryPurple ">Buy now</Button>
          </div>
        </div>
        <div className="flex items-center justify-center text-3xl gap-12  lg:pl-16 py-8 ">
          <p
